<?php
/**
 * Template for contact form email settings.
 *
 * @author  Tech Banker
...
if ( ! is_user_logged_in() ) {
	...
	if ( ! $access_granted ) {
		...
		$coming_soon_type_emails    = wp_create_nonce( 'coming_soon_booster_emails' );
		$coming_soon_type_templates = wp_create_nonce( 'coming_soon_booster_templates' );
		?>
	<div class="page-bar">
						...
						<div class="form-body">
							...
							<div class="form-group" >
								...
								<select name="ux_ddl_user_success" id="ux_ddl_user_success" class="form-control" onchange="coming_soon_booster_email_template_type();">
									<option value="template_for_admin_notification"><?php echo esc_attr( $csb_email_template_for_admin_notification ); ?></option>
									<option value="template_for_client_notification"><?php echo esc_attr( $csb_email_template_for_client_notification ); ?></option>
								</select>
							...
							<div class="form-group">
								...
								wp_editor(
									$email_templates_editor, $id, array(
										'media_buttons' => false,
										'textarea_rows' => 8,
										'tabindex'      => 4,
									)
