 ...
 *
 * @author  Tech Banker
 * @package wp-coming-soon-booster/views/system-information
 * @version 1.0.0
 */
...
if ( ! is_user_logged_in() ) {
	...
	if ( ! $access_granted ) {
		return;
	} elseif ( SYSTEM_INFORMATION_COMING_SOON_BOOSTER === '1' ) {
		?>
		<div class="page-bar">
									...
									<table class="table table-striped table-bordered table-hover" >
										...
										<tbody>
											...
											$params         = array(
												'sslverify' => false,
												'timeout' => 60,
												'user-agent' => 'Coming_Soon_Booster',
												'body'    => $request,
											);
		...
		<div class="row">
			<div class="col-md-12">
				<div class="portlet box vivid-green">
					...
					<div class="portlet-body form">
						<form id="ux_frm_systems_information">
							<div class="form-body">
