...
CustomPQ.prototype = (function () {
   ...
   var sink = function sink(k) {
      while (2 * k <= this.N) {
         var j = 2 * k;
         if (j < this.N && greater(this.arr[j], this.arr[j + 1]))
            ++j;
         if (!greater(this.arr[k], this.arr[j]))
            break;
         exch.call(this, k, j);
         k = j
      }
...
var Ball = (function () {
   ...
   Ball.prototype.timeToHitHorizontalWall = function timeToHitHorizontalWall() {
      if (this.velocityY > 0)
         return (window.innerHeight - this.y - this.radius) / this.velocityY;
...
var Event = (function () {
   ...
   Event.prototype.isValid = function isValid() {
      if (this.a != null && this.a.getCount() != this.countA)
         return !1;
      if (this.b != null && this.b.getCount() != this.countB)
         return !1;
      return !0
   };
...
var CollisionSystem = (function () {
   function CollisionSystem() {
      ...
      this.numBalls = 25;
      window.addEventListener('resize', this.windowResizeHandler.bind(this), !1);
   ...
   CollisionSystem.prototype.predict = function predict(a) {
      ...
      this.balls.forEach(function (ball) {
         ...
         if (dt !== Infinity)
            _this2.pq.insert(new Event(_this2.t + dt, a, ball))
      });
